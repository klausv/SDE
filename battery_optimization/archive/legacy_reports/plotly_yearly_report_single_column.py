...
⚠️ DEPRECATED: This single-column layout variant has been archived.

Use instead: scripts/visualization/plotly_yearly_report_v6_optimized.py

Migration path:
  Old: python scripts/visualization/plotly_yearly_report_single_column.py results/yearly_2024/
  New: python scripts/visualization/plotly_yearly_report_v6_optimized.py results/yearly_2024/

Reason for deprecation:
  - v6_optimized provides better information density with 6×2 grid
  - v6_optimized has auto-detection of battery dimensions from metadata
  - Maintains same Norsk Solkraft theme and interactivity

Archived: 2025-01-11
Will be removed: v2.0 (allow 1 major version transition period)

---

Original description (Forbedringer v2):
